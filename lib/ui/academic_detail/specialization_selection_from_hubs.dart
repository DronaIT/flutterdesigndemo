...
class SpecializationSelectionFromHubs extends StatefulWidget {
  const SpecializationSelectionFromHubs({Key? key}) : super(key: key);

  @override
  State<SpecializationSelectionFromHubs> createState() => _SpecializationSelectionFromHubsState();
}

class _SpecializationSelectionFromHubsState extends State<SpecializationSelectionFromHubs> {
  ...
  BaseApiResponseWithSerializable<HubResponse>? hubData;
  ...
  Future<void> initialization() async {
    ...
    if (Get.arguments != null && Get.arguments[0]["selectedData"] != null) {
      selectedData = Get.arguments[0]["selectedData"];
    }
    if (Get.arguments != null && Get.arguments[1]["hubData"] != null) {
      hubData = Get.arguments[1]["hubData"];
    }
