...
abstract class colors_name {
  ...
  static const Color colorLightGreen2 = Color(0xFFADFFB5);
  static const Color colorLightGreen3 = Color(0xFFC9FFA8);
  ...
  static const Color green = Color(0xFF379100);
  ...
  static const Color textColorBlack = Color(0xFF252525);
  static Color searchFieldTextColor = const Color(0xFF800000).withOpacity(0.5);
